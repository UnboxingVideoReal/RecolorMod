...
namespace RecolorMod.Tiles
{
	public class CinnabarOre : ModTile
	{
		public override void SetStaticDefaults() {
			...
			Main.tileOreFinderPriority[Type] = 500; // Metal Detector value, see https://terraria.gamepedia.com/Metal_Detector
...
/*			Main.tileShine[Type] = 975; */// How often tiny dust appear off this tile. Larger is less frequently
			...
			DustType = 6;
			ItemDrop = ModContent.ItemType<Items.Cinnabar>();
	...
	public class CinnabarOreSystem : ModSystem
	{
	...
	public class CinnabarOrePass : GenPass
	{
		public CinnabarOrePass(string name, float loadWeight) : base(name, loadWeight)
		{
		}
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
		{
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
			{
				...
				//WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<CinnabarOre>());
	...
	//    protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
	//    {
	//        progress.Message = "Cinnabar";
	//        for (var i = 0; i < (int)((Main.maxTilesX * Main.maxTilesY) * 0.0008); i++)
	//        {
	//            WorldGen.OreRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next(Main.maxTilesY - 150, Main.maxTilesY), WorldGen.genRand.Next(2, 6), WorldGen.genRand.Next(3, 5), (ushort)ModContent.TileType<CinnabarOre>());
	//        }
	//    }
	//}
}