...
{
    public class GeoBolt : ModProjectile
    {
        int invisTimer = 0;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Geo Bolt");
        }
        ...
        public override void AI()
        {
            ...
            if (player.whoAmI == Main.myPlayer && (player.dead || !modPlayer.GeoEnchantBool))
            {
                modPlayer.GeoEnchantBool = false;
                Projectile.Kill();
                return;
            }
            ...
            if (Projectile.ai[0] > 0)
            {
                ...
                if (Projectile.ai[0] == 0)
                {
                    ...
                    for (int num227 = 0; num227 < num226; num227++)
                    {
                        ...
                        int num228 = Dust.NewDust(vector6 + vector7, 0, 0, DustID.GreenFairy, 0f, 0f, 0, default(Color), 2f);
