...
{
    public class BloodHoming : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 3; i++) //vanilla dusts
            {
                for (int j = 0; j < 3; ++j)
                {
                    int d = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Blood, 0.0f, 0.0f, 100, default, 1f);
                ...
                {
                    int d = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Blood, 0.0f, 0.0f, 100, default, 0.5f);
