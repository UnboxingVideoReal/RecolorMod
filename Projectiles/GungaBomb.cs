...
{
    public class GungaBomb : ModProjectile
    {
        int invisTimer = 0;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Gunga Bomb");
        }
        ...
        public override void AI()
        {
            ...
            if (player.whoAmI == Main.myPlayer && (player.dead || !modPlayer.GungaEnchantBool))
            {
                modPlayer.GungaEnchantBool = false;
                Projectile.Kill();
                return;
            }
