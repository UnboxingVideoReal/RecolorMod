...
//{
//	public class ContagionUndergroundBiome : ModBiome
//	{
//		public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("ExxoAvalonOrigins/ContagionWaterStyle");
//		public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.Find<ModUndergroundBackgroundStyle>("ExxoAvalonOrigins/ContagionUndergroundBackgroundStyle");

//		public override int Music => MusicID.OtherworldlyUGCrimson; //Mod.GetSoundSlot(SoundType.Music, "Assets/Sounds/Music/41_UndergroundContagion.ogg");
