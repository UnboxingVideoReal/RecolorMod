...
namespace RecolorMod.Items
{
	...
	/// </summary>
	public class ElderBlade : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Elder Blade");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<ElderBladeProj>(); // Remember that we must use ProjectileType<>() since it is a modded projectile!
			...
			Item.damage = 200; // Makes this weapon's damage double the Meowmere's damage.
