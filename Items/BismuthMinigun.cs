...
{
	public class BismuthMinigun : ModItem
	{
        public float actualKnockback = 0f;

		public int actualDamage = 850;
		...
		public override void SetDefaults() {
			...
			Item.rare = ModContent.RarityType<Rarities.UltraBlueRarity>(); // The color that the item's name will be in-game.
			...
			Item.damage = actualDamage; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			Item.knockBack = actualKnockback; // Sets the item's knockback. Note that projectiles shot by this weapon will use its and the used ammunition's knockback added together.
