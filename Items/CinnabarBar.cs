...
namespace RecolorMod.Items
{
	public class CinnabarBar : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.height = 24;
			Item.maxStack = 99;
			Item.value = Item.sellPrice(platinum: 3); // The cost of the item in copper coins. (1 = 1 copper, 100 = 1 silver, 1000 = 1 gold, 10000 = 1 platinum)
			Item.useStyle = ItemUseStyleID.Swing;
			Item.useTurn = true;
			Item.useAnimation = 15;
			Item.useTime = 10;
			Item.autoReuse = true;
			Item.rare = ItemRarityID.Master/*ModContent.RarityType<Rarities.UltraBlueRarity>()*/;
