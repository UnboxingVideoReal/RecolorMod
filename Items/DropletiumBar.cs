...
{
	public class DropletiumBar : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.height = 24;
			Item.maxStack = 99;
			Item.value = Item.sellPrice(4); // The cost of the item in copper coins. (1 = 1 copper, 100 = 1 silver, 1000 = 1 gold, 10000 = 1 platinum)
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<DropletiumBar>(20)
