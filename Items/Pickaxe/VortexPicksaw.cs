...
{
	public class VortexPicksaw : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Vortex Picksaw");
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("RecolorMod/Items/Pickaxe/VortexPicksaw_Glow").Value;
			spriteBatch.Draw
			(
				texture,
				new Vector2
