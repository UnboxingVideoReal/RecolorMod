...
{
    [AutoloadBossHead]
    public class Pyroblaster : ModNPC
	{
        public static int secondStageHeadSlot = -1;
        public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Pyroblaster");
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            //}
            npcLoot.Add(ItemDropRule.Common(Mod.Find<ModItem>("SoulOfHeat").Type, 1, 20, 50));
        }
                    ...
                    else
                    {
                        ...
                        if (NPC.ai[3] >= 60f)
                        {
                            ...
                            if (Main.netMode != 1)
                            {
                                ...
                                int proj = Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), vector50.X, vector50.Y, num533, num534, ProjectileID.Fireball, 60, 0f, Main.myPlayer, 0f, 0f);
            ...
            else
            {
                ...
                if (NPC.ai[1] == 0f)
                {
                    ...
                    if (NPC.localAI[1] > 8f)
                    {
                        ...
                        int proj = Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), vector52.X, vector52.Y, num548, num549, ProjectileID.Fireball, 40, 0f, Main.myPlayer, 0f, 0f);
        ...
        public override void OnKill()
        {
            ...
            if (DownedBossSystem.downedSaturationator && DownedBossSystem.downedWaterBoss)
            {
