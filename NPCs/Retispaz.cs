                ...
                if (NPC.ai[1] == 0f)
                {
                    ...
                    else if (NPC.position.Y + NPC.height < Main.player[NPC.target].position.Y && num496 < 400f)
                    {
                        ...
                        if (NPC.ai[3] >= 40f)
                        {
                            ...
                            if (Main.netMode != 1)
                            {
                                var num499 = (NPC.type == ModContent.NPCType<Retispaz>()) ? 49 : 20;
                                ...
                                Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), vector46.X, vector46.Y, num494, num495, 100, num499, 0, Main.myPlayer, 0, 0f);
                                var num627 = 12f;
                                ...
                                var num632 = NPC.NewNPC((int)vector71.X, (int)vector71.Y, NPCID.Probe);
                                num632 = NPC.NewNPC((int)vector71.X, (int)vector71.Y, NPCID.Probe);
            ...
            else
            {
                ...
                if (NPC.ai[1] == 0f)
                {
                    ...
                    if (NPC.localAI[1] > 100f && Collision.CanHit(NPC.position, NPC.width, NPC.height, Main.player[NPC.target].position, Main.player[NPC.target].width, Main.player[NPC.target].height))
                    {
                        //SecondStage = true;
                        NPC.localAI[1] = 0f;
                        var num513 = (NPC.type == ModContent.NPCType<Retispaz>()) ? 50 : 25;
                        ...
                        Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), vector48.X, vector48.Y, num509, num510, 100, num513, 0f, Main.myPlayer, 0f, 0f);
                        var num627 = 12f;
                        var vector71 = new Vector2(NPC.position.X + NPC.width * 0.5f, NPC.position.Y + NPC.height / 2);
                        var num628 = 100;
                        int num700 = ProjectileID.CursedFlameHostile;
